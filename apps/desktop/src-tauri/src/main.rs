    ...
    fn tauri_ipc_enforces_the_versioned_health_contract() -> Result<(), Box<dyn Error>> {
        ...
        let app = mock_builder()
            ...
            .invoke_handler(tauri::generate_handler![
                ...
                a3_desktop::commands::query_agent_approval,
                a3_desktop::commands::control_agent_approval,
                a3_desktop::commands::query_project_status,
                a3_desktop::commands::query_project_settings,
                a3_desktop::commands::query_index_activity,
                a3_desktop::commands::query_index_run_inspection,
                a3_desktop::commands::query_index_run_files,
                a3_desktop::commands::control_index_run,
                ...
                a3_desktop::commands::query_settings_v2,
                a3_desktop::commands::query_settings_recovery,
                a3_desktop::commands::recover_invalid_model_profiles,
                a3_desktop::commands::rebuild_project_index,
                a3_desktop::commands::remove_project,
                a3_desktop::commands::resume_deep_map,
                a3_desktop::commands::probe_model_role_v2,
                a3_desktop::commands::set_model_provider_credential_v2,
                a3_desktop::commands::delete_model_provider_credential_v2,
                a3_desktop::commands::set_model_provider_enabled_v2,
    ...
    -> Result<(), Box<dyn Error>> {
        ...
        assert_eq!(
            ...
            Some(&json!([
                ...
                "allow-configure-model-provider-v2",
                "allow-delete-model-provider-credential-v2",
                ...
                "allow-query-deep-map-entries",
                "allow-query-deep-map-entry-detail",
                "allow-query-deep-map-run-dashboard",
                "allow-query-deep-map-run-modules",
                "allow-query-deep-map-module-steps",
                "allow-query-deep-map-atlas-impact",
                ...
                "allow-query-agent-ask-research-source-preview",
                "allow-query-agent-diagram-artifacts",
                "allow-query-agent-diagram-artifact",
                "allow-export-agent-diagram",
                "allow-query-agent-work-trace-turns",
                "allow-query-agent-work-trace-detail",
                "allow-query-agent-work-trace-detail-v2",
                "allow-query-agent-work-trace-projection",
                "allow-query-agent-work-trace-sources",
                "allow-query-agent-work-trace-sources-v2",
                ...
                "allow-query-index-run-inspection",
                "allow-query-index-run-files",
                "allow-control-index-run",
                ...
                "allow-query-project-map-atlas-scene",
                "allow-query-project-map-entity-context",
                "allow-query-project-map-inventory-page",
                "allow-query-project-map-flow-scene",
                ...
                "allow-query-health",
                "allow-query-settings-v2",
                "allow-query-settings-recovery",
                "allow-recover-invalid-model-profiles",
                "allow-query-ui-preferences",
                "allow-rebuild-project-index",
                "allow-remove-project",
                "allow-remove-catalog-project",
                "allow-probe-model-role-v2",
                "allow-revise-agent-goal",
                "allow-resume-deep-map",
                "allow-restore-last-project",
                "allow-start-deep-map",
                "allow-set-model-provider-credential-v2",
                "allow-set-model-provider-enabled-v2",
