...
pub use project::{
    ...
    PublishedIndex, RankProjection, RankProjectionError, RankScore, RankScoreError,
    ...
    SnapshotDelta, SnapshotError, SnapshotId, SourcePosition, SourceRange, SourceRangeError,
