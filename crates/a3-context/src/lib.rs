...
use a3_domain::{
    ...
    ContextSection, EvidenceRef, GoalContract, GraphEndpoint, GraphSymbol, ModelProfile,
    ModuleClaimPolarity, ModuleClaimPredicate, ModuleKind, ModuleRoot, Progress, RepositoryCard,
    RepositoryModule, RepositoryPath, SnapshotId, SymbolRole, TaskLedger, TaskLens, TaskLensClaim,
    TaskLensEntry, TaskLensEntryReason, TaskLensSeedSet, TaskLensSeedText, TaskLensTarget,
    TaskLensTokenBudget, TaskStep, TaskStepStatus, VerifiedClaimKind, VerifiedClaimStatus,
};
...
fn reject_secret_candidate(value: &str) -> Result<(), ContextCompileFailure> {
...
mod tests {
    ...
    #[test]
    fn secret_candidates_are_specific_without_matching_normal_words() {
