...
use a3_domain::{
    ...
    GoalContractTimestamp, GoalObjective, GraphSymbol, IndexPublication, IndexRunId,
    IndexRunSequence, IndexRunStart, IndexSchemaVersion, LanguageAdapterRevision,
    LanguageAdapterVersion, LexicalSearchPageSize, LexicalSearchQuery, LexicalSearchTarget,
    LexicalSearchTerm, LinkedGraph, LocalSymbolId, MapperProfileVersion, ModelCapabilities,
